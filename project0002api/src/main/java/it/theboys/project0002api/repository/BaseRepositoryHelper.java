...
public class BaseRepositoryHelper<T, I extends Serializable> extends SimpleMongoRepository<T, I> implements BaseRepository<T, I> {
    private MongoOperations mongoOperations;
    private MongoEntityInformation entityInformation;

    public BaseRepositoryHelper(final MongoEntityInformation entityInformation, final MongoOperations mongoOperations) {
