...
public enum CahSetExpansion {
    CAH_EXPANSION(0,"All versions of the Cards Against Humanity base set, including international versions, officially sold by CAH.","Cards Against Humanity: Expansions", UserRole.MODERATOR),
    ...
    CAH_PACKS(2,"All the packs officially sold or released by CAH.","Cards Against Humanity: Packs", UserRole.MODERATOR),
    ...
    KICKSTARTER(5,"Sets funded on Kickstarter that were only available through the Kickstarter campaign. Kickstarter sets that end up being sold commercially are added to the Third Party Commercial or Stand Alone Games sheets.","", UserRole.MODERATOR),
